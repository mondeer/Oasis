...
*/
Auth::routes();
Route::get('logout', '\Oasis\Http\Controllers\Auth\LoginController@logout');
...
{
    Route::get('', 'StudentCtrl@index')->name('index');
    Route::get('create', 'StudentCtrl@create')->name('create');
    Route::post('', 'StudentCtrl@store')->name('store');
    Route::post('/datatable', 'StudentCtrl@datatable')->name('datatable');
    Route::get('{student}', 'StudentCtrl@show')->name('show');
    Route::get('{student}/edit', 'StudentCtrl@edit')->name('edit');
    Route::put('{student}', 'StudentCtrl@update')->name('update');
    Route::delete('{student}', 'StudentCtrl@destroy')->name('destroy');
});
/*
// |--------------------------------------------------------------------------
// | Doctor
